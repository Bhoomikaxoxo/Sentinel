const RULE_WEIGHTS = {
  ...
  missing_spf: { score: -5, desc: "Missing SPF DNS record (minor email authentication protection notice)." },
  missing_dmarc: { score: -5, desc: "Missing DMARC DNS record (lacks email authentication enforcement)." },
  security_headers_passed: { score: 10, desc: "Security Headers Audit passed (HSTS, CSP, X-Frame-Options, X-Content-Type)." },
